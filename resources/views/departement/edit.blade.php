...
<form method="POST" action="{{ route('departement.update', $departement->id) }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="nama_departement" id="nama_departement" class="form-control" placeholder="Nama Barang" value="{{ $departement->nama_departement }}" required>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="lokasi_departement" id="lokasi_departement" class="form-control" placeholder="Kode Barang" value="{{ $departement->lokasi_departement }}" required>
        <div class="invalid-feedback">
