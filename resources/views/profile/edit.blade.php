                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <div class="author">
                                    <a href="#">
                                        <img class="avatar border-gray" src="https://img.freepik.com/free-photo/user-profile-front-side_187299-39595.jpg?w=740&t=st=1707127578~exp=1707128178~hmac=05a67c595b9efea21ed2cd048e9b806b7b72d76cd0780778c40529d8f260f94d" alt="...">
                                        <h5 class="title">{{ __(auth()->user()->nama) }}</h5>
                                    </a>
                                    <p class="description">
                                        {{ __(auth()->user()->role) }}
                                    </p>
